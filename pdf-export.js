...
await page.goto(`file:${path.join(__dirname, 'index.html')}`, {waitUntil: 'load', timeout: 0})
await page.pdf({ path: 'resume.pdf', format: 'letter', printBackground: true })
await page.goto(`file:${path.join(__dirname, 'matthew-nestor.html')}`, {waitUntil: 'load', timeout: 0})
